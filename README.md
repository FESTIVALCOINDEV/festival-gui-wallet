...
msbuild FestivalWallet.sln /m /p:Configuration=Release
```
...
To run the GUI wallet, the FestivalCoin daemon is not required to run. If a daemon already runs, it will be used - otherwise the wallet will use its own "internal daemon" instead.
