...
// Copyright (c) 2016-2018 The FestivalCoin developers
...
MainWindow::MainWindow() : QMainWindow(), m_ui(new Ui::MainWindow), m_trayIcon(nullptr), m_tabActionGroup(new QActionGroup(this)),
  ...
  m_connectionStateIconLabel->setStyleSheet(".QPushButton { background-color: rgba(240, 240, 240, 0);}");
...
void MainWindow::initUi() {
  setWindowTitle(QString(tr("FestivalCoin Wallet v1.0.1")).arg(Settings::instance().getVersion()));
#ifdef Q_OS_WIN32
  createTrayIcon();
#endif
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at www.festivalcoin.net in Documentation section"));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("FestivalCoin Wallet %1")).arg(Settings::instance().getVersion());
