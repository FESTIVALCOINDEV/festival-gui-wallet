...
const QString BITCOIN_IPC_PREFIX("FestivalCoin:");

static QString ipcServerName()
{
    QString name("FestivalCoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start FestivalCoin: click-to-pay handler");
    else
...
{
    // clicking on FestivalCoin: URLs creates FileOpen events on the Mac:
